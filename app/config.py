...
SQLALCHEMY_DATABASE_URI = "mssql+pyodbc://Phantasos:Onelookdarkroom!@localhost/Chacharitas_final?trusted_connection=yes&driver=ODBC+Driver+18+for+SQL+Server&Encrypt=no"
